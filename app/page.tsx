...
const SAMPLE_CONVERSATIONS: Conversation[] = [
  {
    id: 'sample-1',
    title: 'สรุปบทความ: จีนแก้ด้วยอาวุธไมโครเวฟพลังงานสูง',
    ...
    messages: [
      {
        id: 's1-m1',
        role: 'user',
        content: 'ช่วยสรุปบทความนี้ให้หน่อย:\n\nจีนแก้ด้วยอาวุธไมโครเวฟพลังงานสูง โดย นิติการุณย์ มิ่งรุจิราลัย\n\n24 ก.พ. 2022 เริ่มสงครามรัสเซีย-อูเครน รัสเซียโจมตีเครือข่าย Viasat\n26 ก.พ. 2022 อูเครนทวีตขอช่วยเหลือจากอีลอน มัสก์\n28 ก.พ. 2022 สตาร์ลิงก์ล็อตแรกถึงอูเครน\n\nม.ค. 2026 สตาร์ลิงก์เปิดฟรีในอิหร่าน สเปซเอกซ์ส่งดาวเทียมไปแล้ว 11,138 ดวง ยังอยู่ในวงโคจร 9,646 ดวง อนุมัติ 12,000 แผนระยะยาว 42,000 ดวง\n\nดาวเทียมโคจรที่ 550 กม. ความเร็ว 27,000 กม./ชม. วนรอบโลก 90-95 นาที ออกแบบเป็น Mesh Network ครอบคลุมทั้งโลก\n\nภารกิจ 2026: Direct to Cell (ส่งสัญญาณเข้าสมาร์ตโฟนโดยตรง) และ Starshield (เครือข่ายสำหรับกองทัพ)\n\n13 ม.ค. 2026 จีนตีพิมพ์ผลทดสอบ TPG1000Cs อาวุธไมโครเวฟพลังงานสูง (HPM) จาก NINT เมืองซีอาน พลังงาน 20 GW ต่อเนื่อง 1 นาที (200,000 พัลส์) สถิติใหม่ของโลก ขนาด 4 เมตร หนัก 5 ตัน ฉายา "Starlink Killer" ไม่สร้างขยะอวกาศ ไร้ร่องรอยการยิง',
        timestamp: new Date(Date.now() - 3500000).toISOString(),
      },
      {
        id: 's1-m2',
        role: 'agent',
        content: '## สรุปบทความ: จีนแก้ด้วยอาวุธไมโครเวฟพลังงานสูง\n\nโดย นิติการุณย์ มิ่งรุจิราลัย\n\n---\n\n### ไทม์ไลน์สำคัญ\n- **24 ก.พ. 2022** - รัสเซียบุกอูเครน โจมตีเครือข่าย Viasat จนล่ม\n- **28 ก.พ. 2022** - สตาร์ลิงก์ล็อตแรกถึงอูเครน กลายเป็นโครงสร้างพื้นฐานสำคัญ\n- **ม.ค. 2026** - สตาร์ลิงก์เปิดฟรีในอิหร่านเพื่อสนับสนุนผู้ประท้วง\n- **13 ม.ค. 2026** - จีนตีพิมพ์ผลทดสอบ TPG1000Cs\n\n### หมวด 1: สถานะสตาร์ลิงก์\n- ส่งดาวเทียมแล้ว **11,138 ดวง** (ใช้งาน 9,646)\n- อนุมัติ 12,000 / แผนระยะยาว 42,000 ดวง\n- วงโคจรต่ำ (LEO) ที่ **550 กม.** ความเร็ว 27,000 กม./ชม.\n- ออกแบบเป็น **Mesh Network** ครอบคลุมทั่วโลก\n\n### หมวด 2: ภารกิจปี 2026\n- **Direct to Cell** - ส่งสัญญาณ 4G/5G เข้าสมาร์ตโฟนโดยตรง\n- **Starshield** - เครือข่ายลับสำหรับรัฐบาลและกองทัพสหรัฐ (เฝ้าระวัง + สื่อสาร)\n\n### หมวด 3: อาวุธตอบโต้ของจีน (TPG1000Cs)\n- **ประเภท:** High-Power Microwave (HPM)\n- **พัฒนาโดย:** สถาบัน NINT เมืองซีอาน\n- **กำลัง:** 20 GW ต่อเนื่อง 1 นาที (สถิติโลก)\n- **ขนาด:** 4 เมตร / 5 ตัน (ติดตั้งบนรถบรรทุก เรือรบ เครื่องบิน หรือดาวเทียม)\n- **ฉายา:** Starlink Killer\n\n### หมวด 4: ข้อได้เปรียบของ HPM\n- ไม่สร้างขยะอวกาศ (เผาวงจรภายในโดยไม่ทำลายโครงสร้าง)\n- จัดการดาวเทียมจำนวนมากพร้อมกัน ต้นทุนต่ำ\n- **ไร้ร่องรอย** - แยกไม่ออกว่าถูกโจมตีหรือเสียเอง\n\n### ข้อสรุปเชิงกลยุทธ์\nสหรัฐเน้น **ปริมาณ** (ส่งดาวเทียมหมื่นดวง) แต่จีนเน้น **คุณภาพการตอบโต้** ด้วยเทคโนโลยีที่อาจทำลายทั้งกองเรือดาวเทียมได้ในเวลาไม่กี่นาที',
